...
#' copy the previous approved model as the new "base" model
#'
...
#'
#' @examples
#' approved_model(base_year = 2018, base_model = "m2", year = 2020)
approved_model <- function(base_year, base_model, year){
  ...
  write.table(c(paste("You are using", base_model, "from", base_year, "as your base model.")),
              file = here::here(year, "base", paste0("base model_", base_year, "_", base_model,".txt")),
